...
@Generated(
        ...
        date = "2025-05-19T12:33:17.587352600+02:00",
...
public class BloodPressureAnyEventIntervalEvent implements IntervalEventEntity, BloodPressureAnyEventChoice {
    ...
    /**
     * Path: Presión Sanguínea/Blood pressure/Any event/width
     */
    @Path("/width|value")
    private TemporalAmount widthValue;

    /**
     * Path: Presión Sanguínea/Blood pressure/Any event/math_function
     */
    @Path("/math_function|defining_code")
    private MathFunction mathFunctionDefiningCode;

    /**
     * Path: Presión Sanguínea/Blood pressure/Any event/sample_count
     */
    @Path("/sample_count")
