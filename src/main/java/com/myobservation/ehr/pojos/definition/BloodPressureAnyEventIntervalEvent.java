...
@Generated(
    ...
    date = "2025-05-22T10:35:38.111455300+02:00",
...
public class BloodPressureAnyEventIntervalEvent implements IntervalEventEntity, BloodPressureAnyEventChoice {
  ...
  /**
   * Path: blood_pressure/Blood pressure/Any event/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: blood_pressure/Blood pressure/Any event/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: blood_pressure/Blood pressure/Any event/sample_count
   */
  @Path("/sample_count")
