...
@Generated(
    ...
    date = "2025-05-22T10:35:38.100095200+02:00",
...
public class BloodPressureObservation implements EntryEntity {
  /**
   * Path: blood_pressure/Blood pressure/origin
   */
  @Path("/data[at0001]/origin|value")
  private TemporalAccessor originValue;

  /**
   * Path: blood_pressure/Blood pressure/Tree/Location of measurement/null_flavour
   */
  ...
  /**
   * Path: blood_pressure/Blood pressure/Structured measurement location
  ...
  /**
   * Path: blood_pressure/Blood pressure/Method
  ...
  /**
   * Path: blood_pressure/Blood pressure/Extension
  ...
  /**
   * Path: blood_pressure/Blood pressure/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: blood_pressure/Blood pressure/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: blood_pressure/Blood pressure/feeder_audit
   */
  @Path("/feeder_audit")
  private FeederAudit feederAudit;

  /**
   * Path: blood_pressure/Blood pressure/Any event
  ...
  /**
   * Path: blood_pressure/Blood pressure/Location of measurement
